...
end_date = '02/25/2021'
tickers = ['msft', 'aapl', 'twtr', 'intc', 'tsm', 'goog', 'amzn', 'fb', 'nvda','jnj','bac','nflx','azn','blk','sbux']
data = web.DataReader(tickers, data_source = 'yahoo', start = start_date, end = end_date)['Adj Close']
...
# 
# The observed p-value is 0.073359, which is greater than the chosen alpha = 0.05. Therefore, we reject the alternative hypothesis and we do not consider the signals produced by the trading strategy (using momentum) to be significative.
